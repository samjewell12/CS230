        ...
        <div class="h-40 center-me">
            <div class="my-auto">
                <form class="form-signin" action="includes/login-helper.php" method="post">
                    ...
                    <p class="hint-text"> login bro</p>
                    
                    


                    <label for="inputEmail" class="sr-only">Email address/Username</label>
                    <input type="text" class="form-control" name="uname-email" placeholder="Username/Email address"
                        required autofocus>
                    ...
                    <button class="btn btn-lg btn-outline-primary btn-block" name="signup-submit" type="submit">Login</button>
